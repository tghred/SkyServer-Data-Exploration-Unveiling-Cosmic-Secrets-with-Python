...
# 5. الرسم البياني باستخدام Scatter لأن البيانات متباعدة زمنياً (22 نقطة عبر السنين)
fig, ax = plt.subplots(2, 1, figsize=(10, 8), sharex=True)

# الرسمة العلوية: المنحنى الضوئي (مع توصيل النقاط بخط رفيع لرؤية النمط)
...
# الرسمة السفلية: الفروقات الزهرية (معدل التغير بين الرصدات)
